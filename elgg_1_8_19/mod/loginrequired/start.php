...
function loginrequired_init()
{
  ...
  $allow[] = 'action/sytick/ajax/home';
  $allow[] = 'sytick/welcome';
  $allow[] = 'sytick/forgotpassword';
  $allow[] = 'sytick/resetpassword';
  $allow[] = 'sytick/activatemanager';
  $allow[] = 'sytick/activateemployee';
