...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr bgcolor="#bd3505">
    ...
    <td colspan="2"><img src="<?php get_image_path('email_logo.gif')?>" width="99" height="42" /></td>
  </tr>
  <tr>
    <td height="60">&nbsp;</td>
    <td width="577"><?php echo elgg_echo('resend_activation:body:line1', array($vars['username']));?></td>
    <td width="119">&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('resend_activation:line2', array( $vars['sitename']));?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('resend_activation:body:line3');?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
   ...
   <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('forgot_password:body:line4');?></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
