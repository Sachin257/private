<div id="content_body">
    	<div class="cnt_wrap">
        	<div class="ackno_wrap MT_four" align="center">
            	<h1 align="center"><?php echo elgg_echo('activate_manager:title')?></h1>
                <p><?php echo elgg_echo("activate:manager:text");?></p>
                ...
                <div class="MT_three">
					...
					echo elgg_view('input/submit', array('name' => 'submit', 'class'=>'btn_resend MR_one', 'id'=>'btn_activate_manager','value' => elgg_echo('activate_employee:create_password')));
					?>
                </div>
            </div>
        </div>
