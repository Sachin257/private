...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="60">&nbsp;</td>
    <td width="577"><?php echo elgg_echo('forgot_password:body:line1', array($vars['username']));?></td>
    <td width="119">&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('forgot_password:body:line2', array( $vars['ip_address']));?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('forgot_password:body:line3');?></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="40">&nbsp;</td>
    <td><?php echo elgg_echo('forgot_password:body:line4',array($vars['link']));?></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
